...
extension NotesQueryFilter on QueryBuilder<Notes, Notes, QFilterCondition> {
  QueryBuilder<Notes, Notes, QAfterFilterCondition> colorEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> colorGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> colorLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> colorBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NotesQuerySortBy on QueryBuilder<Notes, Notes, QSortBy> {
  QueryBuilder<Notes, Notes, QAfterSortBy> sortByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<Notes, Notes, QAfterSortBy> sortByColorDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NotesQuerySortThenBy on QueryBuilder<Notes, Notes, QSortThenBy> {
  QueryBuilder<Notes, Notes, QAfterSortBy> thenByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<Notes, Notes, QAfterSortBy> thenByColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.desc);
    });
  }
...
extension NotesQueryWhereDistinct on QueryBuilder<Notes, Notes, QDistinct> {
  QueryBuilder<Notes, Notes, QDistinct> distinctByColor() {
    return QueryBuilder.apply(this, (query) {
...
extension NotesQueryProperty on QueryBuilder<Notes, Notes, QQueryProperty> {
  ...
  QueryBuilder<Notes, int, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
