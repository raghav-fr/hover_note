...
class _ScheduledPageState extends State<ScheduledPage> {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Text("Delete Notes", style: AppTextStyle.aristabold20),
          content: Text(
            "Move ${_selectedNoteIds.length} notes and their schedules to trash?",
  ...
  Widget build(BuildContext context) {
    ...
    final notes =
        noteDatabase.scheduledNotes.where((note) {
                                    ...
                                    child: Container(
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          hintText: "Search scheduled notes...",
